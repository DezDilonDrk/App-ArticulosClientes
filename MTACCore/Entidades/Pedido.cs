...
namespace MTCore_AC.Entidades
{
    public class Pedido
    {
        ...
        public Pedido() {}
        public Pedido(string id_cliente, string DniCliente, string nombre_cliente, string MetodoPago, string Estado, double PorcentajeImpuestos, DateTime? FechaEnvio)
        {
